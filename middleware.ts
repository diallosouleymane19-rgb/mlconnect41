...
export async function middleware(request: NextRequest) {
  ...
  const isInscription = path.startsWith('/transporteur/inscription'); // Allow public access to inscription
...
export const config = {
  matcher: ['/((?!_next/static|_next/image|favicon.ico|api/fn|\\.netlify|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico)$).*)'],
};
